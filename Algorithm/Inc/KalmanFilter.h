...
typedef struct kf_t
{
    ...
    mat K;         // kalman gain  K
    mat S, temp_matrix0, temp_matrix1, temp_vector0, temp_vector1;

    int8_t MatStatus;// 存储矩阵运算的状态（成功/错误码）
    ...
    float *R_data;
    float *K_data;
    float *S_data, *temp_matrix_data0, *temp_matrix_data1, *temp_vector_data0, *temp_vector_data1;
} KalmanFilter_t;
